...
// import { getLeaderboard } from '../services/apiService'; // Will create this later
    ...
    const fetchLeaderboard = async () => {
      try {
        ...
        const mockData: ScoreEntry[] = [
          { username: 'Player1', high_score: 15000 },
          { username: 'Player2', high_score: 12000 },
          { username: 'Player3', high_score: 10000 },
          { username: 'Player4', high_score: 8000 },
          { username: 'Player5', high_score: 5000 },
        ];
        setLeaderboard(mockData.sort((a,b) => b.high_score - a.high_score));
      } catch (err: any) {
